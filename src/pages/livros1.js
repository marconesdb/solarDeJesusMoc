...
import livro5 from '../images/A Reencarnação de uma Rainha/A Reencarnação de uma Rainha.jpg';
import livro6 from '../images/A vida viaja na luz/A vida viaja na luz.jpg';
import livro7 from '../images/Bem-aventurados os que oram/Bem-aventurados os que oram.png';
import livro8 from '../images/Em outra dimensão - o outro lado do véu/Em outra dimensão - o outro lado do véu.jpg';
import livro9 from '../images/Marta/Marta.jpg';
 import livro10 from '../images/Mecanismos da Mediunidade/Mecanismos da Mediunidade.jpg';
...
export const livros1 = [
    ...
    { image: livro5, title: 'A Reencarnação de uma Rainha', description: 'Nesta narrativa, J. W. Rochester apresenta a história de Panderva, uma figura que sobrevive nas ruas de Florença, enfrentando perigos e desafios com a mesma dignidade que exibia em seus dias como rainha. Em meio a um enredo onde o bem e o mal...  ', price: '35,00' },
    { image: livro6, title: 'A Vida viaja na luz', description: 'O Dr. Inácio Ferreira nos guia rumo a uma compreensão mais abrangente sobre a vida no Mundo Espiritual, abrindo vastos horizontes para que, através da Fé Raciocinada, possamos desenvolver uma visão mais precisa de nossa condição como os filhos...', price: '50,00' },
    { image: livro7, title: 'Bem-aventurados os que oram', description: 'Bem-aventurados são. Na cruz dos tormentos seus. Os que choram de aflição. Sem perder a fé em Deus - Eurícledes Formiga', price: '91,00' },
    { image: livro8, title: 'Em outra Dimensão - O outro lado do véu', description: 'Durante uma intervenção cirúrgica, Alan Smith vivenciou a mais extraordinária e maravilhosa experiência de sua vida. Enquanto seu corpo era submetido aos procedimentos da operação, ele testemunhou a equipe médica em ação, desesperadamente tentando preservar...', price: '77,00' },
    { image: livro9, title: 'Marta', description: 'A personagem principal, Marta, é uma mulher interiorana, criada pelo pai, Gumercindo, um viúvo que se dedicou proficuamente à família, à igreja e ao trabalho. Ao desencarnar, Gumercindo é socorrido e depara-se com uma realidade espiritual completamente...', price: '102,00' },
     { image: livro10, title: 'Mecanismos da Mediunidade', description: 'O Espírito André Luiz combina Ciência e Espiritismo para apresentar conceitos como energia, átomo, obsessão, hipnose, magnetismo, animismo e psicometria, entre outros. Ele oferece aos médiuns e estudiosos da mediunidade diversos recursos para...', price: '65,00' },
