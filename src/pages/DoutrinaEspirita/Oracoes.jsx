...
// Mapa: idioma i18n → chave do objeto de áudio
const LANG_KEY = {
  pt: 'pt',
  en: 'en',
  es: 'es',
...
const getMimeType = (url) =>
  url?.endsWith('.mp4') ? 'audio/mp4' : 'audio/mpeg';

const prayersData = [
  { id: 1,  img: img1,  titleKey: 'prayer1',  subtitleKey: null,              audio: { pt: audioPortugues1,  en: audioEnglish1,  es: audioEspanol1,  fr: audioFrances1  } },
  { id: 2,  img: img2,  titleKey: 'prayer2',  subtitleKey: null,              audio: { pt: audioPortugues2,  en: audioEnglish2,  es: audioEspanol2,  fr: audioFrances2  } },
  { id: 3,  img: img3,  titleKey: 'prayer3',  subtitleKey: 'subtitlePrayer3', audio: { pt: audioPortugues3,  en: audioEnglish3,  es: audioEspanol3,  fr: audioFrances3  } },
  { id: 4,  img: img4,  titleKey: 'prayer4',  subtitleKey: 'subtitlePrayer4', audio: { pt: audioPortugues4,  en: audioEnglish4,  es: audioEspanol4,  fr: audioFrances4  } },
  { id: 5,  img: img5,  titleKey: 'prayer5',  subtitleKey: 'subtitlePrayer5', audio: { pt: audioPortugues5,  en: audioEnglish5,  es: audioEspanol5,  fr: audioFrances5  } },
  { id: 6,  img: img6,  titleKey: 'prayer6',  subtitleKey: 'subtitlePrayer6', audio: { pt: audioPortugues6,  en: audioEnglish6,  es: audioEspanol6,  fr: audioFrances6  } },
  { id: 7,  img: img7,  titleKey: 'prayer7',  subtitleKey: 'subtitlePrayer7', audio: { pt: audioPortugues7,  en: audioEnglish7,  es: audioEspanol7,  fr: audioFrances7  } },
  { id: 8,  img: img8,  titleKey: 'prayer8',  subtitleKey: 'subtitlePrayer8', audio: { pt: audioPortugues8,  en: audioEnglish8,  es: audioEspanol8,  fr: audioFrances8  } },
  { id: 9,  img: img9,  titleKey: 'prayer9',  subtitleKey: 'subtitlePrayer9', audio: { pt: audioPortugues9,  en: audioEnglish9,  es: audioEspanol9,  fr: audioFrances9  } },
  { id: 10, img: img10, titleKey: 'prayer10', subtitleKey: 'subtitlePrayer10',audio: { pt: audioPortugues10, en: audioEnglish10, es: audioEspanol10, fr: audioFrances10 } },
  { id: 11, img: img11, titleKey: 'prayer11', subtitleKey: 'subtitlePrayer11',audio: { pt: audioPortugues11, en: audioEnglish11, es: audioEspanol11, fr: audioFrances11 } },
  { id: 12, img: img12, titleKey: 'prayer12', subtitleKey: 'subtitlePrayer12',audio: { pt: audioPortugues12, en: audioEnglish12, es: audioEspanol12, fr: audioFrances12 } },
  { id: 13, img: img13, titleKey: 'prayer13', subtitleKey: 'subtitlePrayer13',audio: { pt: audioPortugues13, en: audioEnglish13, es: audioEspanol13, fr: audioFrances13 } },
  { id: 14, img: img14, titleKey: 'prayer14', subtitleKey: 'subtitlePrayer14',audio: { pt: audioPortugues14, en: audioEnglish14, es: audioEspanol14, fr: audioFrances14 } },
  { id: 15, img: img15, titleKey: 'prayer15', subtitleKey: 'subtitlePrayer15',audio: { pt: audioPortugues15, en: audioEnglish15, es: audioEspanol15, fr: audioFrances15 } },
  { id: 16, img: img16, titleKey: 'prayer16', subtitleKey: 'subtitlePrayer16',audio: { pt: audioPortugues16, en: audioEnglish16, es: audioEspanol16, fr: audioFrances16 } },
  { id: 17, img: img17, titleKey: 'prayer17', subtitleKey: 'subtitlePrayer17',audio: { pt: audioPortugues17, en: audioEnglish17, es: audioEspanol17, fr: audioFrances17 } },
];

// --- PLAYER ÚNICO ---
const SingleAudioPlayer = ({ src, label }) => {
  const audioRef = useRef(null);

  // Sempre que o src mudar (troca de idioma), recarrega sem dar play automático
  useEffect(() => {
    if (audioRef.current) {
  ...
  return (
    <div className="flex flex-col items-center mt-4">
      ...
      <audio ref={audioRef} controls className="w-1/2 h-10">
...
function Oracoes() {
  ...
  // "pt-BR" → "pt" | fallback para "pt" se idioma não mapeado
  const currentLang = i18n.language.slice(0, 2);
  const langKey = LANG_KEY[currentLang] ?? 'pt';

  // Label exibido abaixo do player conforme o idioma ativo
  const langLabel = {
    pt: 'Português',
    en: 'English',
    es: 'Español',
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="space-y-8">
          {prayersData.map((prayer) => {
            const activeSrc = prayer.audio[langKey]; // ← arquivo do idioma ativo
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-center text-center md:text-left w-full">
                  ...
                  {/* ← Um único player que troca conforme o idioma da navbar */}
                  <SingleAudioPlayer
                    src={activeSrc}
                    label={langLabel[langKey]}
                  />
                </div>
              </div>
            );
